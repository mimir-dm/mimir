...
updated_at: 2026-01-20T02:44:01.453503+00:00
parent: MIMIR-I-0042
blocked_by: []
archived: false
...
- [ ] Create tables for all 12 remaining entity types
- [ ] Each table has `name`, `source`, and `data` columns minimum
- [ ] All tables reference `catalog_sources(code)` for source
- [ ] Index on `name` for each table
