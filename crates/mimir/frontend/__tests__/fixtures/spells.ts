...
export const srdSpells: Record<string, any>[] = [
  {
    "areaTags": [
      "MT",
      "ST"
  ...
  },
  {
    ...
    "fluff": {
      "images": [
        {
          "href": {
            "path": "spells/PHB/Sacred Flame.webp",
            "type": "internal"
          },
          "type": "image"
        }
  ...
  },
  {
    ...
    "fluff": {
      "images": [
        {
          "href": {
            "path": "spells/PHB/Magic Missile.webp",
            "type": "internal"
          },
          "type": "image"
        }
  ...
  },
  {
    ...
    "fluff": {
      "images": [
        {
          "href": {
            "path": "spells/PHB/Dimension Door.webp",
            "type": "internal"
          },
          "type": "image"
        }
...
export const eldritchBlast = srdSpells[0]
export const fireBolt = srdSpells[1]
export const guidance = srdSpells[2]
export const light = srdSpells[3]
export const mageHand = srdSpells[4]
export const minorIllusion = srdSpells[5]
export const prestidigitation = srdSpells[6]
export const sacredFlame = srdSpells[7]
export const bless = srdSpells[8]
export const cureWounds = srdSpells[9]
export const detectMagic = srdSpells[10]
export const healingWord = srdSpells[11]
export const mageArmor = srdSpells[12]
export const magicMissile = srdSpells[13]
export const shield = srdSpells[14]
export const thunderwave = srdSpells[15]
export const holdPerson = srdSpells[16]
export const lesserRestoration = srdSpells[17]
export const mistyStep = srdSpells[18]
export const scorchingRay = srdSpells[19]
export const spiritualWeapon = srdSpells[20]
export const counterspell = srdSpells[21]
export const dispelMagic = srdSpells[22]
export const fireball = srdSpells[23]
export const lightningBolt = srdSpells[24]
export const revivify = srdSpells[25]
export const spiritGuardians = srdSpells[26]
export const banishment = srdSpells[27]
export const dimensionDoor = srdSpells[28]
export const greaterInvisibility = srdSpells[29]
export const polymorph = srdSpells[30]
export const coneofCold = srdSpells[31]
export const greaterRestoration = srdSpells[32]
export const raiseDead = srdSpells[33]
export const wallofForce = srdSpells[34]
export const chainLightning = srdSpells[35]
export const disintegrate = srdSpells[36]
export const heal = srdSpells[37]
export const fingerofDeath = srdSpells[38]
export const teleport = srdSpells[39]
export const powerWordStun = srdSpells[40]
export const powerWordKill = srdSpells[41]
export const wish = srdSpells[42]
